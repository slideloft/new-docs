...
{% api-method method="get" host="/ledgers/:ledger\_sequence/transactions?cursor={paging\_token}&order={asc,desc}&limit={1-200}&include\_failed{true,false}" path="" %}
{% api-method-summary %}
​
...
{% api-method-parameter name="sequence" type="string" required=true %}
...
{% api-method-parameter name="include\_failed" type="string" required=false %}
