...
{% tab title="cURL" %}
```bash
curl "https://expansion-testnet.bantu.network/paths/strict-send?source_asset_type=credit_alphanum4&source_asset_code=BRL&source_asset_issuer=GDVKY2GU2DRXWTBEYJJWSFXIGBZV6AZNBVVSUHEPZI54LIS6BA7DVVSP&source_amount=400&destination_account=GAYOLLLUIZE4DZMBB2ZBKGBUBZLIOYU6XFLW37GBP2VZD3ABNXCW4BVA"
```
{% endtab %}
{% endtabs %}
