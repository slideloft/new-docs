...
We chose Stencil so you can learn by doing: it’s an easy way to create a web-based application, which means you can see the ins and outs of building a Bantu wallet start to finish. Bantu also has a [suite of SDKs](../software-and-sdks/index.md) in various programming languages, so if Javascript isn’t your thing, you can follow along, and recreate the steps below using one of them.
