...
* `network` is the [network passphrase](../content/docs/glossary/network-passphrase.md) that this core instance is using to decide whether to connect to the testnet or the public network
