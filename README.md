...
![Ordered List](.gitbook/assets/ordered-list.png)
...
![Quote](.gitbook/assets/quote.png)
...
![AttributeTable Component](.gitbook/assets/attribute-table.png)
...
![AttributeTable with Type](.gitbook/assets/attributetable-with-type.png)
...
![AttributeTable without Type](.gitbook/assets/attributetable-without-type.png)

#### Alert

![Alert Component](.gitbook/assets/alert.png)
...
![CodeExample Component](.gitbook/assets/code-example.png)
...
![Endpoint Component](.gitbook/assets/endpoint.png)
...
![EndpointsTable Component](.gitbook/assets/endpointstable.png)

`<EndpointsTable/>` displays an endpoint and its [HTTP method](https://en.wikipedia.org/wiki/Hypertext_Transfer_Protocol#Request_methods).
...
![ExampleResponse Component](.gitbook/assets/exampleresponse.png)
...
![MethodTable Component](https://github.com/slideloft/new-docs/tree/046158a008b14dc6d54bdd6f4c48e078c303a05e/readme-imgs/MethodTable.png)
...
![Diagrams](.gitbook/assets/mermaid.png)
